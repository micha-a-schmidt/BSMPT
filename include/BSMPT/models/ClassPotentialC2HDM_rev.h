...
#ifndef SRC_CLASSPOTENTIALC2HDM_REV_H_
#define SRC_CLASSPOTENTIALC2HDM_REV_H_
 ...
 */
class Class_Potential_C2HDM_rev : public Class_Potential_Origin
{
public:
  Class_Potential_C2HDM_rev ();
  virtual  ~Class_Potential_C2HDM_rev () override;
