...
namespace Models
{
Class_Potential_C2HDM_rev::Class_Potential_C2HDM_rev()
{
  // TODO Auto-generated constructor stub
  Model         = ModelID::ModelIDs::C2HDMREV;
  NNeutralHiggs = 4;
  NChargedHiggs = 4;
 ...
 */
std::vector<std::string> Class_Potential_C2HDM_rev::addLegendCT() const
{
 ...
 * inputfile
 */
std::vector<std::string> Class_Potential_C2HDM_rev::addLegendTemp() const
{
  std::vector<std::string> labels;
...
Class_Potential_C2HDM_rev::addLegendTripleCouplings() const
{
  std::vector<std::string> labels;
 ...
 */
std::vector<std::string> Class_Potential_C2HDM_rev::addLegendVEV() const
{
  std::vector<std::string> labels;
...
void Class_Potential_C2HDM_rev::ReadAndSet(const std::string &linestr,
...
void Class_Potential_C2HDM_rev::set_gen(const std::vector<double> &p)
{
...
void Class_Potential_C2HDM_rev::set_CT_Pot_Par(const std::vector<double> &p)
{
  //	double *p = (double *)par;
 ...
 */
void Class_Potential_C2HDM_rev::write() const
{
 ...
 * conserving)
 */
std::vector<double> Class_Potential_C2HDM_rev::calc_CT() const
{
...
void Class_Potential_C2HDM_rev::TripleHiggsCouplings()
{
  if (!SetCurvatureDone) SetCurvatureArrays();
...
void Class_Potential_C2HDM_rev::SetCurvatureArrays()
{
  initVectors();
...
bool Class_Potential_C2HDM_rev::CalculateDebyeSimplified()
{
  double cb = 0;
...
bool Class_Potential_C2HDM_rev::CalculateDebyeGaugeSimplified()
{
...
double
Class_Potential_C2HDM_rev::VTreeSimplified(const std::vector<double> &v) const
{
  double res = 0;
...
double Class_Potential_C2HDM_rev::VCounterSimplified(
