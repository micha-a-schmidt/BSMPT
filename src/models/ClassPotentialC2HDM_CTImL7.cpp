...
namespace Models
{
Class_Potential_C2HDM_CTImL7::Class_Potential_C2HDM_CTImL7()
{
  // TODO Auto-generated constructor stub
  Model         = ModelID::ModelIDs::C2HDMCTIML7;
  NNeutralHiggs = 4;
  NChargedHiggs = 4;
 ...
 */
std::vector<std::string> Class_Potential_C2HDM_CTImL7::addLegendCT() const
{
 ...
 * inputfile
 */
std::vector<std::string> Class_Potential_C2HDM_CTImL7::addLegendTemp() const
{
  std::vector<std::string> labels;
...
Class_Potential_C2HDM_CTImL7::addLegendTripleCouplings() const
{
  std::vector<std::string> labels;
 ...
 */
std::vector<std::string> Class_Potential_C2HDM_CTImL7::addLegendVEV() const
{
  std::vector<std::string> labels;
...
void Class_Potential_C2HDM_CTImL7::ReadAndSet(const std::string &linestr,
...
void Class_Potential_C2HDM_CTImL7::set_gen(const std::vector<double> &p)
{
...
void Class_Potential_C2HDM_CTImL7::set_CT_Pot_Par(const std::vector<double> &p)
{
  //	double *p = (double *)par;
 ...
 */
void Class_Potential_C2HDM_CTImL7::write() const
{
  ...
  std::cout << "CTImLam7 = " << CTImLam7 << std::endl;
 ...
 * conserving)
 */
std::vector<double> Class_Potential_C2HDM_CTImL7::calc_CT() const
{
  ...
  // DIL5CT
  parCT.push_back((-2 * HCW(4, 5)) / std::pow(v2, 2));
  ...
  // CTImLam7
  parCT.push_back((v1 * HCW(4, 5)) / std::pow(v2, 3) + HCW(6, 7) / (v1 * v2));
  ...
  if (std::abs(HCW(0, 3) + HCW(5, 6)) > 1e-10)
    CRelations.push_back(0);
  else
    CRelations.push_back(1);
...
void Class_Potential_C2HDM_CTImL7::TripleHiggsCouplings()
{
  if (!SetCurvatureDone) SetCurvatureArrays();
...
void Class_Potential_C2HDM_CTImL7::SetCurvatureArrays()
{
  initVectors();
...
bool Class_Potential_C2HDM_CTImL7::CalculateDebyeSimplified()
{
  double cb = 0;
...
bool Class_Potential_C2HDM_CTImL7::CalculateDebyeGaugeSimplified()
{
...
double Class_Potential_C2HDM_CTImL7::VTreeSimplified(
...
double Class_Potential_C2HDM_CTImL7::VCounterSimplified(
    const std::vector<double> &v) const
{
  (void)v;
...
void Class_Potential_C2HDM_CTImL7::Debugging(const std::vector<double> &input,
