...
namespace Models
{
Class_Potential_C2HDM_GenIm::Class_Potential_C2HDM_GenIm()
{
  // TODO Auto-generated constructor stub
  Model         = ModelID::ModelIDs::C2HDMGENIM;
  NNeutralHiggs = 4;
  NChargedHiggs = 4;
 ...
 */
std::vector<std::string> Class_Potential_C2HDM_GenIm::addLegendCT() const
{
 ...
 * inputfile
 */
std::vector<std::string> Class_Potential_C2HDM_GenIm::addLegendTemp() const
{
  std::vector<std::string> labels;
...
Class_Potential_C2HDM_GenIm::addLegendTripleCouplings() const
{
  std::vector<std::string> labels;
 ...
 */
std::vector<std::string> Class_Potential_C2HDM_GenIm::addLegendVEV() const
{
  std::vector<std::string> labels;
...
void Class_Potential_C2HDM_GenIm::ReadAndSet(const std::string &linestr,
...
void Class_Potential_C2HDM_GenIm::set_gen(const std::vector<double> &p)
{
...
void Class_Potential_C2HDM_GenIm::set_CT_Pot_Par(const std::vector<double> &p)
{
  //	double *p = (double *)par;
...

  {
    ...
    Curvature_Higgs_CT_L4[0][2][2][3] = -CTImLam7;

    Curvature_Higgs_CT_L4[0][2][3][0] = -DIL5CT;

    Curvature_Higgs_CT_L4[0][2][3][1] = DRL5CT;

    Curvature_Higgs_CT_L4[0][2][3][2] = -CTImLam7;
    ...
    Curvature_Higgs_CT_L4[0][6][3][6] = -CTImLam7;
    ...
    Curvature_Higgs_CT_L4[0][6][6][3] = -CTImLam7;
    ...
    Curvature_Higgs_CT_L4[0][7][3][7] = -CTImLam7;
    ...
    Curvature_Higgs_CT_L4[0][7][7][3] = -CTImLam7;
    ...
    Curvature_Higgs_CT_L4[1][2][2][2] = 3 * CTImLam7;

    Curvature_Higgs_CT_L4[1][2][3][0] = DRL5CT;

    Curvature_Higgs_CT_L4[1][2][3][1] = DIL5CT;

    Curvature_Higgs_CT_L4[1][2][3][3] = CTImLam7;
    ...
    Curvature_Higgs_CT_L4[1][6][2][6] = CTImLam7;
    ...
    Curvature_Higgs_CT_L4[1][6][6][2] = CTImLam7;
    ...
    Curvature_Higgs_CT_L4[1][7][2][7] = CTImLam7;
    ...
    Curvature_Higgs_CT_L4[1][7][7][2] = CTImLam7;
    ...
    Curvature_Higgs_CT_L4[2][0][2][3] = -CTImLam7;

    Curvature_Higgs_CT_L4[2][0][3][0] = -DIL5CT;

    Curvature_Higgs_CT_L4[2][0][3][1] = DRL5CT;

    Curvature_Higgs_CT_L4[2][0][3][2] = -CTImLam7;
    ...
    Curvature_Higgs_CT_L4[2][1][2][2] = 3 * CTImLam7;

    Curvature_Higgs_CT_L4[2][1][3][0] = DRL5CT;

    Curvature_Higgs_CT_L4[2][1][3][1] = DIL5CT;

    Curvature_Higgs_CT_L4[2][1][3][3] = CTImLam7;
    ...
    Curvature_Higgs_CT_L4[2][3][0][2] = -CTImLam7;

    Curvature_Higgs_CT_L4[2][3][1][0] = DRL5CT;

    Curvature_Higgs_CT_L4[2][3][1][1] = DIL5CT;

    Curvature_Higgs_CT_L4[2][3][1][3] = CTImLam7;

    Curvature_Higgs_CT_L4[2][3][2][0] = -CTImLam7;

    Curvature_Higgs_CT_L4[2][3][2][3] = DL2CT;

    Curvature_Higgs_CT_L4[2][3][3][1] = CTImLam7;
    ...
    Curvature_Higgs_CT_L4[2][4][2][7] = -CTImLam7;
    ...
    Curvature_Higgs_CT_L4[2][4][7][2] = -CTImLam7;
    ...
    Curvature_Higgs_CT_L4[2][5][2][6] = CTImLam7;
    ...
    Curvature_Higgs_CT_L4[2][5][6][2] = CTImLam7;
    ...
    Curvature_Higgs_CT_L4[2][6][1][6] = CTImLam7;

    Curvature_Higgs_CT_L4[2][6][2][5] = CTImLam7;
    ...
    Curvature_Higgs_CT_L4[2][6][5][2] = CTImLam7;

    Curvature_Higgs_CT_L4[2][6][6][1] = CTImLam7;
    ...
    Curvature_Higgs_CT_L4[2][7][1][7] = CTImLam7;

    Curvature_Higgs_CT_L4[2][7][2][4] = -CTImLam7;
    ...
    Curvature_Higgs_CT_L4[3][2][0][2] = -CTImLam7;

    Curvature_Higgs_CT_L4[3][2][1][0] = DRL5CT;

    Curvature_Higgs_CT_L4[3][2][1][1] = DIL5CT;

    Curvature_Higgs_CT_L4[3][2][1][3] = CTImLam7;

    Curvature_Higgs_CT_L4[3][2][2][0] = -CTImLam7;

    Curvature_Higgs_CT_L4[3][2][2][3] = DL2CT;

    Curvature_Higgs_CT_L4[3][2][3][1] = CTImLam7;
    ...
    Curvature_Higgs_CT_L4[3][3][0][3] = -3 * CTImLam7;

    Curvature_Higgs_CT_L4[3][3][1][0] = -DIL5CT;

    Curvature_Higgs_CT_L4[3][3][1][1] = DL3CT + DL4CT + DRL5CT;

    Curvature_Higgs_CT_L4[3][3][1][2] = CTImLam7;

    Curvature_Higgs_CT_L4[3][3][2][1] = CTImLam7;

    Curvature_Higgs_CT_L4[3][3][2][2] = DL2CT;

    Curvature_Higgs_CT_L4[3][3][3][0] = -3 * CTImLam7;

    Curvature_Higgs_CT_L4[3][3][3][3] = 3 * DL2CT;

    Curvature_Higgs_CT_L4[3][3][4][4] = DL3CT;

    Curvature_Higgs_CT_L4[3][3][4][7] = -CTImLam7;

    Curvature_Higgs_CT_L4[3][3][5][5] = DL3CT;

    Curvature_Higgs_CT_L4[3][3][5][6] = CTImLam7;

    Curvature_Higgs_CT_L4[3][3][6][5] = CTImLam7;

    Curvature_Higgs_CT_L4[3][3][6][6] = DL2CT;

    Curvature_Higgs_CT_L4[3][3][7][4] = -CTImLam7;
    ...
    Curvature_Higgs_CT_L4[3][4][3][7] = -CTImLam7;
    ...
    Curvature_Higgs_CT_L4[3][4][7][3] = -CTImLam7;
    ...
    Curvature_Higgs_CT_L4[3][5][3][6] = CTImLam7;
    ...
    Curvature_Higgs_CT_L4[3][5][6][3] = CTImLam7;
    ...
    Curvature_Higgs_CT_L4[3][6][5][3] = CTImLam7;

    Curvature_Higgs_CT_L4[3][6][6][0] = -CTImLam7;
    ...
    Curvature_Higgs_CT_L4[4][2][2][7] = -CTImLam7;
    ...
    Curvature_Higgs_CT_L4[4][2][7][2] = -CTImLam7;
    ...
    Curvature_Higgs_CT_L4[4][3][3][7] = -CTImLam7;
    ...
    Curvature_Higgs_CT_L4[4][3][7][3] = -CTImLam7;
    ...
    Curvature_Higgs_CT_L4[4][6][6][7] = -CTImLam7;

    Curvature_Higgs_CT_L4[4][6][7][4] = -DIL5CT;

    Curvature_Higgs_CT_L4[4][6][7][5] = DRL5CT;

    Curvature_Higgs_CT_L4[4][6][7][6] = -CTImLam7;
    ...
    Curvature_Higgs_CT_L4[5][2][2][6] = CTImLam7;
    ...
    Curvature_Higgs_CT_L4[5][2][6][2] = CTImLam7;
    ...
    Curvature_Higgs_CT_L4[5][3][3][6] = CTImLam7;
    ...
    Curvature_Higgs_CT_L4[5][3][6][3] = CTImLam7;
    ...
    Curvature_Higgs_CT_L4[5][6][6][6] = 3 * CTImLam7;

    Curvature_Higgs_CT_L4[5][6][7][4] = DRL5CT;

    Curvature_Higgs_CT_L4[5][6][7][5] = DIL5CT;

    Curvature_Higgs_CT_L4[5][6][7][7] = CTImLam7;
    ...
    Curvature_Higgs_CT_L4[6][0][3][6] = -CTImLam7;
    ...
    Curvature_Higgs_CT_L4[6][0][6][3] = -CTImLam7;
    ...
    Curvature_Higgs_CT_L4[6][1][2][6] = CTImLam7;
    ...
    Curvature_Higgs_CT_L4[6][1][6][2] = CTImLam7;
    ...
    Curvature_Higgs_CT_L4[6][2][1][6] = CTImLam7;

    Curvature_Higgs_CT_L4[6][2][2][5] = CTImLam7;
    ...
    Curvature_Higgs_CT_L4[6][2][5][2] = CTImLam7;

    Curvature_Higgs_CT_L4[6][2][6][1] = CTImLam7;
    ...
    Curvature_Higgs_CT_L4[6][3][5][3] = CTImLam7;

    Curvature_Higgs_CT_L4[6][3][6][0] = -CTImLam7;
    ...
    Curvature_Higgs_CT_L4[6][4][6][7] = -CTImLam7;

    Curvature_Higgs_CT_L4[6][4][7][4] = -DIL5CT;

    Curvature_Higgs_CT_L4[6][4][7][5] = DRL5CT;

    Curvature_Higgs_CT_L4[6][4][7][6] = -CTImLam7;
    ...
    Curvature_Higgs_CT_L4[6][5][6][6] = 3 * CTImLam7;

    Curvature_Higgs_CT_L4[6][5][7][4] = DRL5CT;

    Curvature_Higgs_CT_L4[6][5][7][5] = DIL5CT;

    Curvature_Higgs_CT_L4[6][5][7][7] = CTImLam7;

    Curvature_Higgs_CT_L4[6][6][0][0] = DL3CT;

    Curvature_Higgs_CT_L4[6][6][0][3] = -CTImLam7;

    Curvature_Higgs_CT_L4[6][6][1][1] = DL3CT;

    Curvature_Higgs_CT_L4[6][6][1][2] = CTImLam7;

    Curvature_Higgs_CT_L4[6][6][2][1] = CTImLam7;

    Curvature_Higgs_CT_L4[6][6][2][2] = DL2CT;

    Curvature_Higgs_CT_L4[6][6][3][0] = -CTImLam7;
    ...
    Curvature_Higgs_CT_L4[6][6][4][7] = -CTImLam7;

    Curvature_Higgs_CT_L4[6][6][5][4] = DIL5CT;

    Curvature_Higgs_CT_L4[6][6][5][5] = DL3CT + DL4CT - DRL5CT;

    Curvature_Higgs_CT_L4[6][6][5][6] = 3 * CTImLam7;

    Curvature_Higgs_CT_L4[6][6][6][5] = 3 * CTImLam7;

    Curvature_Higgs_CT_L4[6][6][6][6] = 3 * DL2CT;

    Curvature_Higgs_CT_L4[6][6][7][4] = -CTImLam7;
    ...
    Curvature_Higgs_CT_L4[6][7][4][6] = -CTImLam7;

    Curvature_Higgs_CT_L4[6][7][5][4] = DRL5CT;

    Curvature_Higgs_CT_L4[6][7][5][5] = DIL5CT;

    Curvature_Higgs_CT_L4[6][7][5][7] = CTImLam7;

    Curvature_Higgs_CT_L4[6][7][6][4] = -CTImLam7;

    Curvature_Higgs_CT_L4[6][7][6][7] = DL2CT;

    Curvature_Higgs_CT_L4[6][7][7][5] = CTImLam7;
    ...
    Curvature_Higgs_CT_L4[7][0][3][7] = -CTImLam7;
    ...
    Curvature_Higgs_CT_L4[7][0][7][3] = -CTImLam7;
    ...
    Curvature_Higgs_CT_L4[7][1][2][7] = CTImLam7;
    ...
    Curvature_Higgs_CT_L4[7][1][7][2] = CTImLam7;
    ...
    Curvature_Higgs_CT_L4[7][2][1][7] = CTImLam7;

    Curvature_Higgs_CT_L4[7][2][2][4] = -CTImLam7;
    ...
    Curvature_Higgs_CT_L4[7][7][4][7] = -3 * CTImLam7;

    Curvature_Higgs_CT_L4[7][7][5][4] = -DIL5CT;

    Curvature_Higgs_CT_L4[7][7][5][5] = DL3CT + DL4CT + DRL5CT;

    Curvature_Higgs_CT_L4[7][7][5][6] = CTImLam7;

    Curvature_Higgs_CT_L4[7][7][6][5] = CTImLam7;

    Curvature_Higgs_CT_L4[7][7][6][6] = DL2CT;

    Curvature_Higgs_CT_L4[7][7][7][4] = -3 * CTImLam7;
 ...
 */
void Class_Potential_C2HDM_GenIm::write() const
{
  ...
  std::cout << "Write out of the CTparams " << std::endl;
  std::cout << "Du1CT = " << Du1CT << std::endl;
  std::cout << "Du2CT = " << Du2CT << std::endl;
  std::cout << "DIu3CT = " << DIu3CT << std::endl;
  std::cout << "DRu3CT = " << DRu3CT << std::endl;
  std::cout << "DL1CT = " << DL1CT << std::endl;
  std::cout << "DL2CT = " << DL2CT << std::endl;
  std::cout << "DL3CT = " << DL3CT << std::endl;
  ...
  std::cout << "CTImL6 = " << CTImLam6 << std::endl;
  std::cout << "CTImL7 = " << CTImLam7 << std::endl;
 ...
 * conserving)
 */
std::vector<double> Class_Potential_C2HDM_GenIm::calc_CT() const
{
  ...
  // Du2CT
  parCT.push_back(dummy1 * std::pow(v1, 2) + (v1 * HCW(4, 6)) / (2. * v2) -
                  (v1 * HCW(5, 7)) / (2. * v2) + HCW(6, 6) / 2. -
                  (3 * HCW(7, 7)) / 2.);

  // DIu3CT
  parCT.push_back(HCW(4, 7) / 2. + (v2 * HCW(6, 7)) / (2. * v1) +
                  (3 * NCW(5)) / (2. * v2));

  // DRu3CT
  parCT.push_back(dummy1 * v1 * v2 + HCW(5, 7));

  // DL1CT
  parCT.push_back(-((dummy1 * std::pow(v2, 2)) / std::pow(v1, 2)) -
                  HCW(4, 4) / std::pow(v1, 2) + HCW(5, 5) / std::pow(v1, 2));

  // DL2CT
  parCT.push_back(-((dummy1 * std::pow(v1, 2)) / std::pow(v2, 2)) -
                  HCW(6, 6) / std::pow(v2, 2) + HCW(7, 7) / std::pow(v2, 2));

  // DL3CT
  parCT.push_back(-dummy1 + HCW(1, 3) / (v1 * v2) -
                  HCW(3, 3) / std::pow(v1, 2) - HCW(4, 6) / (v1 * v2) +
                  HCW(7, 7) / std::pow(v1, 2));

  // DL4CT
  parCT.push_back(dummy1 + (2 * HCW(3, 3)) / std::pow(v1, 2) -
                  (2 * HCW(7, 7)) / std::pow(v1, 2));

  // DRL5CT
  parCT.push_back(dummy1);

  // DIL5CT
  parCT.push_back((-2 * dummy2 * v1) / v2 - (2 * HCW(4, 5)) / std::pow(v2, 2));

  // DTCharged
  parCT.push_back(-NCW(2));

  // DT1
  parCT.push_back(v1 * HCW(5, 5) + v2 * HCW(5, 7) - NCW(4));

  // DT2
  parCT.push_back(v1 * HCW(1, 3) + v2 * HCW(3, 3) - NCW(6));

  // DT3
  parCT.push_back(-((v1 * NCW(5)) / v2) - NCW(7));

  // CTImLam6
  parCT.push_back(dummy2);

  // CTImLam7
  parCT.push_back((dummy2 * std::pow(v1, 2)) / std::pow(v2, 2) +
                  (v1 * HCW(4, 5)) / std::pow(v2, 3) + HCW(6, 7) / (v1 * v2));
  ...
  std::vector<double> CRelations{
      ...
      v2 + (v1 * HCW(0, 3)) / HCW(6, 7) + (v1 * HCW(5, 6)) / HCW(6, 7),

      HCW(1, 1) - HCW(5, 5) - (HCW(0, 2) * HCW(0, 3)) / HCW(6, 7) -
          (HCW(0, 2) * HCW(5, 6)) / HCW(6, 7) +
          (HCW(0, 3) * HCW(5, 7)) / HCW(6, 7) +
          (HCW(5, 6) * HCW(5, 7)) / HCW(6, 7),
      ...
      // (HCW(0, 0) - HCW(5, 5) && HCW(0, 2) - HCW(5, 7) && HCW(6, 7) != 0) ||
      //     (-((HCW(0, 2) * HCW(0, 3)) / (HCW(0, 0) - HCW(5, 5))) -
      //          (HCW(0, 2) * HCW(5, 6)) / (HCW(0, 0) - HCW(5, 5)) +
      //          (HCW(0, 3) * HCW(5, 7)) / (HCW(0, 0) - HCW(5, 5)) +
      //          (HCW(5, 6) * HCW(5, 7)) / (HCW(0, 0) - HCW(5, 5)) +
      //          (HCW(0, 0) * HCW(6, 7)) / (HCW(0, 0) - HCW(5, 5)) -
      //          (HCW(5, 5) * HCW(6, 7)) / (HCW(0, 0) - HCW(5, 5)) &&
      //      HCW(0, 0) != HCW(5, 5) && HCW(0, 2) != HCW(5, 7)),

  };
  /////////////////////////////////////////////////

  std::cout << std::endl;
  for (size_t i = 0; i < CRelations.size(); i++)
    std::cout << "CRel(" << i << ") = " << CRelations.at(i) << std::endl;
  std::cout << std::endl;

  return parCT;
}

void Class_Potential_C2HDM_GenIm::TripleHiggsCouplings()
{
  if (!SetCurvatureDone) SetCurvatureArrays();
...
void Class_Potential_C2HDM_GenIm::SetCurvatureArrays()
{
  initVectors();
...
bool Class_Potential_C2HDM_GenIm::CalculateDebyeSimplified()
{
  double cb = 0;
...
bool Class_Potential_C2HDM_GenIm::CalculateDebyeGaugeSimplified()
{
...
double
Class_Potential_C2HDM_GenIm::VTreeSimplified(const std::vector<double> &v) const
{
  double res = 0;
...
double Class_Potential_C2HDM_GenIm::VCounterSimplified(
...
void Class_Potential_C2HDM_GenIm::Debugging(const std::vector<double> &input,
