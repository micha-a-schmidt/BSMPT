...
#include <BSMPT/models/ClassPotentialC2HDM_CTReL6.h>
...
namespace Models
{
Class_Potential_C2HDM_CTReL6::Class_Potential_C2HDM_CTReL6()
{
  // TODO Auto-generated constructor stub
  Model         = ModelID::ModelIDs::C2HDMCTREL6;
  NNeutralHiggs = 4;
  NChargedHiggs = 4;
 ...
 */
std::vector<std::string> Class_Potential_C2HDM_CTReL6::addLegendCT() const
{
 ...
 * inputfile
 */
std::vector<std::string> Class_Potential_C2HDM_CTReL6::addLegendTemp() const
{
  std::vector<std::string> labels;
...
Class_Potential_C2HDM_CTReL6::addLegendTripleCouplings() const
{
  std::vector<std::string> labels;
 ...
 */
std::vector<std::string> Class_Potential_C2HDM_CTReL6::addLegendVEV() const
{
  std::vector<std::string> labels;
...
void Class_Potential_C2HDM_CTReL6::ReadAndSet(const std::string &linestr,
...
void Class_Potential_C2HDM_CTReL6::set_gen(const std::vector<double> &p)
{
...
void Class_Potential_C2HDM_CTReL6::set_CT_Pot_Par(const std::vector<double> &p)
{
  //	double *p = (double *)par;
  ...
  Curvature_Higgs_CT_L2[7][7] = Du2CT;
  {
    ...
    Curvature_Higgs_CT_L4[0][0][0][2] = 3 * CTReLam6;

    Curvature_Higgs_CT_L4[0][0][1][1] = DL1CT;

    Curvature_Higgs_CT_L4[0][0][1][3] = CTReLam6;

    Curvature_Higgs_CT_L4[0][0][2][0] = 3 * CTReLam6;

    Curvature_Higgs_CT_L4[0][0][2][2] = DL3CT + DL4CT + DRL5CT;

    Curvature_Higgs_CT_L4[0][0][2][3] = -DIL5CT;

    Curvature_Higgs_CT_L4[0][0][3][1] = CTReLam6;
    ...
    Curvature_Higgs_CT_L4[0][4][0][6] = CTReLam6;

    Curvature_Higgs_CT_L4[0][4][2][4] = CTReLam6;
    ...
    Curvature_Higgs_CT_L4[0][4][4][2] = CTReLam6;

    Curvature_Higgs_CT_L4[0][4][6][0] = CTReLam6;
    ...
    Curvature_Higgs_CT_L4[0][5][0][7] = CTReLam6;

    Curvature_Higgs_CT_L4[0][5][2][5] = CTReLam6;
    ...
    Curvature_Higgs_CT_L4[0][6][4][0] = CTReLam6;
    ...
    Curvature_Higgs_CT_L4[0][7][0][5] = CTReLam6;
    ...
    Curvature_Higgs_CT_L4[0][7][5][0] = CTReLam6;
    ...
    Curvature_Higgs_CT_L4[1][0][0][3] = CTReLam6;

    Curvature_Higgs_CT_L4[1][0][1][0] = DL1CT;

    Curvature_Higgs_CT_L4[1][0][1][2] = CTReLam6;

    Curvature_Higgs_CT_L4[1][0][2][1] = CTReLam6;

    Curvature_Higgs_CT_L4[1][0][2][2] = DIL5CT;

    Curvature_Higgs_CT_L4[1][0][2][3] = DRL5CT;

    Curvature_Higgs_CT_L4[1][0][3][0] = CTReLam6;
    ...
    Curvature_Higgs_CT_L4[1][1][0][2] = CTReLam6;

    Curvature_Higgs_CT_L4[1][1][1][1] = 3 * DL1CT;

    Curvature_Higgs_CT_L4[1][1][1][3] = 3 * CTReLam6;

    Curvature_Higgs_CT_L4[1][1][2][0] = CTReLam6;

    Curvature_Higgs_CT_L4[1][1][2][2] = DL3CT + DL4CT - DRL5CT;

    Curvature_Higgs_CT_L4[1][1][2][3] = DIL5CT;

    Curvature_Higgs_CT_L4[1][1][3][1] = 3 * CTReLam6;
    ...
    Curvature_Higgs_CT_L4[1][1][4][6] = CTReLam6;

    Curvature_Higgs_CT_L4[1][1][5][5] = DL1CT;

    Curvature_Higgs_CT_L4[1][1][5][7] = CTReLam6;

    Curvature_Higgs_CT_L4[1][1][6][4] = CTReLam6;

    Curvature_Higgs_CT_L4[1][1][6][6] = DL3CT;

    Curvature_Higgs_CT_L4[1][1][7][5] = CTReLam6;

    Curvature_Higgs_CT_L4[1][1][7][7] = DL3CT;

    Curvature_Higgs_CT_L4[1][2][0][1] = CTReLam6;

    Curvature_Higgs_CT_L4[1][2][0][2] = DIL5CT;

    Curvature_Higgs_CT_L4[1][2][0][3] = DRL5CT;

    Curvature_Higgs_CT_L4[1][2][1][0] = CTReLam6;
    ...
    Curvature_Higgs_CT_L4[1][3][0][0] = CTReLam6;

    Curvature_Higgs_CT_L4[1][3][0][2] = DRL5CT;

    Curvature_Higgs_CT_L4[1][3][0][3] = -DIL5CT;

    Curvature_Higgs_CT_L4[1][3][1][1] = 3 * CTReLam6;
    ...
    Curvature_Higgs_CT_L4[1][4][4][3] = CTReLam6;

    Curvature_Higgs_CT_L4[1][4][6][1] = CTReLam6;
    ...
    Curvature_Higgs_CT_L4[1][6][4][1] = CTReLam6;
    ...
    Curvature_Higgs_CT_L4[1][7][1][5] = CTReLam6;
    ...
    Curvature_Higgs_CT_L4[1][7][5][1] = CTReLam6;
    ...
    Curvature_Higgs_CT_L4[2][1][0][1] = CTReLam6;

    Curvature_Higgs_CT_L4[2][1][0][2] = DIL5CT;

    Curvature_Higgs_CT_L4[2][1][0][3] = DRL5CT;

    Curvature_Higgs_CT_L4[2][1][1][0] = CTReLam6;
    ...
    Curvature_Higgs_CT_L4[2][4][0][4] = CTReLam6;
    ...
    Curvature_Higgs_CT_L4[2][4][4][0] = CTReLam6;
    ...
    Curvature_Higgs_CT_L4[2][5][0][5] = CTReLam6;
    ...
    Curvature_Higgs_CT_L4[2][5][5][0] = CTReLam6;
    ...
    Curvature_Higgs_CT_L4[3][1][0][0] = CTReLam6;

    Curvature_Higgs_CT_L4[3][1][0][2] = DRL5CT;

    Curvature_Higgs_CT_L4[3][1][0][3] = -DIL5CT;

    Curvature_Higgs_CT_L4[3][1][1][1] = 3 * CTReLam6;
    ...
    Curvature_Higgs_CT_L4[3][4][1][4] = CTReLam6;
    ...
    Curvature_Higgs_CT_L4[3][4][4][1] = CTReLam6;
    ...
    Curvature_Higgs_CT_L4[3][5][1][5] = CTReLam6;
    ...
    Curvature_Higgs_CT_L4[3][5][5][1] = CTReLam6;
    ...
    Curvature_Higgs_CT_L4[4][0][0][6] = CTReLam6;

    Curvature_Higgs_CT_L4[4][0][2][4] = CTReLam6;
    ...
    Curvature_Higgs_CT_L4[4][0][4][2] = CTReLam6;

    Curvature_Higgs_CT_L4[4][0][6][0] = CTReLam6;
    ...
    Curvature_Higgs_CT_L4[4][1][4][3] = CTReLam6;

    Curvature_Higgs_CT_L4[4][1][6][1] = CTReLam6;
    ...
    Curvature_Higgs_CT_L4[4][2][0][4] = CTReLam6;
    ...
    Curvature_Higgs_CT_L4[4][2][4][0] = CTReLam6;
    ...
    Curvature_Higgs_CT_L4[4][3][1][4] = CTReLam6;
    ...
    Curvature_Higgs_CT_L4[4][3][4][1] = CTReLam6;
    ...
    Curvature_Higgs_CT_L4[4][4][0][2] = CTReLam6;

    Curvature_Higgs_CT_L4[4][4][1][1] = DL1CT;

    Curvature_Higgs_CT_L4[4][4][1][3] = CTReLam6;

    Curvature_Higgs_CT_L4[4][4][2][0] = CTReLam6;

    Curvature_Higgs_CT_L4[4][4][2][2] = DL3CT;

    Curvature_Higgs_CT_L4[4][4][3][1] = CTReLam6;

    Curvature_Higgs_CT_L4[4][4][3][3] = DL3CT;

    Curvature_Higgs_CT_L4[4][4][4][4] = 3 * DL1CT;

    Curvature_Higgs_CT_L4[4][4][4][6] = 3 * CTReLam6;

    Curvature_Higgs_CT_L4[4][4][5][5] = DL1CT;

    Curvature_Higgs_CT_L4[4][4][5][7] = CTReLam6;

    Curvature_Higgs_CT_L4[4][4][6][4] = 3 * CTReLam6;

    Curvature_Higgs_CT_L4[4][4][6][6] = DL3CT + DL4CT + DRL5CT;

    Curvature_Higgs_CT_L4[4][4][6][7] = -DIL5CT;

    Curvature_Higgs_CT_L4[4][4][7][5] = CTReLam6;
    ...
    Curvature_Higgs_CT_L4[5][0][0][7] = CTReLam6;

    Curvature_Higgs_CT_L4[5][0][2][5] = CTReLam6;
    ...
    Curvature_Higgs_CT_L4[5][2][5][0] = CTReLam6;
    ...
    Curvature_Higgs_CT_L4[5][3][1][5] = CTReLam6;
    ...
    Curvature_Higgs_CT_L4[5][3][5][1] = CTReLam6;
    ...
    Curvature_Higgs_CT_L4[5][4][4][7] = CTReLam6;

    Curvature_Higgs_CT_L4[5][4][5][4] = DL1CT;

    Curvature_Higgs_CT_L4[5][4][5][6] = CTReLam6;

    Curvature_Higgs_CT_L4[5][4][6][5] = CTReLam6;

    Curvature_Higgs_CT_L4[5][4][6][6] = DIL5CT;

    Curvature_Higgs_CT_L4[5][4][6][7] = DRL5CT;

    Curvature_Higgs_CT_L4[5][4][7][4] = CTReLam6;
    ...
    Curvature_Higgs_CT_L4[5][5][0][2] = CTReLam6;

    Curvature_Higgs_CT_L4[5][5][1][1] = DL1CT;

    Curvature_Higgs_CT_L4[5][5][1][3] = CTReLam6;

    Curvature_Higgs_CT_L4[5][5][2][0] = CTReLam6;

    Curvature_Higgs_CT_L4[5][5][2][2] = DL3CT;

    Curvature_Higgs_CT_L4[5][5][3][1] = CTReLam6;

    Curvature_Higgs_CT_L4[5][5][3][3] = DL3CT;

    Curvature_Higgs_CT_L4[5][5][4][4] = DL1CT;

    Curvature_Higgs_CT_L4[5][5][4][6] = CTReLam6;

    Curvature_Higgs_CT_L4[5][5][5][5] = 3 * DL1CT;

    Curvature_Higgs_CT_L4[5][5][5][7] = 3 * CTReLam6;

    Curvature_Higgs_CT_L4[5][5][6][4] = CTReLam6;

    Curvature_Higgs_CT_L4[5][5][6][6] = DL3CT + DL4CT - DRL5CT;

    Curvature_Higgs_CT_L4[5][5][6][7] = DIL5CT;

    Curvature_Higgs_CT_L4[5][5][7][5] = 3 * CTReLam6;
    ...
    Curvature_Higgs_CT_L4[5][6][4][5] = CTReLam6;

    Curvature_Higgs_CT_L4[5][6][4][6] = DIL5CT;

    Curvature_Higgs_CT_L4[5][6][4][7] = DRL5CT;

    Curvature_Higgs_CT_L4[5][6][5][4] = CTReLam6;
    ...
    Curvature_Higgs_CT_L4[5][7][4][4] = CTReLam6;

    Curvature_Higgs_CT_L4[5][7][4][6] = DRL5CT;

    Curvature_Higgs_CT_L4[5][7][4][7] = -DIL5CT;

    Curvature_Higgs_CT_L4[5][7][5][5] = 3 * CTReLam6;
    ...
    Curvature_Higgs_CT_L4[6][0][0][4] = CTReLam6;
    ...
    Curvature_Higgs_CT_L4[6][0][4][0] = CTReLam6;
    ...
    Curvature_Higgs_CT_L4[6][1][1][4] = CTReLam6;
    ...
    Curvature_Higgs_CT_L4[6][1][4][1] = CTReLam6;
    ...
    Curvature_Higgs_CT_L4[6][5][4][5] = CTReLam6;

    Curvature_Higgs_CT_L4[6][5][4][6] = DIL5CT;

    Curvature_Higgs_CT_L4[6][5][4][7] = DRL5CT;

    Curvature_Higgs_CT_L4[6][5][5][4] = CTReLam6;
    ...
    Curvature_Higgs_CT_L4[7][0][0][5] = CTReLam6;
    ...
    Curvature_Higgs_CT_L4[7][0][5][0] = CTReLam6;
    ...
    Curvature_Higgs_CT_L4[7][1][1][5] = CTReLam6;
    ...
    Curvature_Higgs_CT_L4[7][1][5][1] = CTReLam6;
    ...
    Curvature_Higgs_CT_L4[7][5][4][4] = CTReLam6;

    Curvature_Higgs_CT_L4[7][5][4][6] = DRL5CT;

    Curvature_Higgs_CT_L4[7][5][4][7] = -DIL5CT;

    Curvature_Higgs_CT_L4[7][5][5][5] = 3 * CTReLam6;
 ...
 */
void Class_Potential_C2HDM_CTReL6::write() const
{
  ...
  std::cout << "CTReLam6 = " << CTReLam6 << std::endl;
 ...
 * conserving)
 */
std::vector<double> Class_Potential_C2HDM_CTReL6::calc_CT() const
{
  ...
  double dummyL6 = 0;
  // Du1CT
  parCT.push_back((dummyL6 * v1 * v2) / 2. + DRL5CT * std::pow(v2, 2) +
                  HCW(4, 4) / 2. + (v2 * HCW(4, 6)) / (2. * v1) -
                  (3 * HCW(5, 5)) / 2. - (v2 * HCW(5, 7)) / (2. * v1));

  // Du2CT
  parCT.push_back(dummy1 * std::pow(v1, 2) +
                  (dummyL6 * std::pow(v1, 3)) / (2. * v2) +
                  (v1 * HCW(4, 6)) / (2. * v2) - (v1 * HCW(5, 7)) / (2. * v2) +
                  HCW(6, 6) / 2. - (3 * HCW(7, 7)) / 2.);

  // DIu3CT
  parCT.push_back(-HCW(5, 6) + (2 * NCW(5)) / v2);

  // DRu3CT
  parCT.push_back((dummyL6 * std::pow(v1, 2)) / 2. + DRL5CT * v1 * v2 +
                  HCW(5, 7));

  // DL1CT
  parCT.push_back((-2 * dummyL6 * v2) / v1 -
                  (dummy1 * std::pow(v2, 2)) / std::pow(v1, 2) -
  ...
  // DL3CT
  parCT.push_back(-dummy1 - (dummyL6 * v1) / v2 -
                  (2 * HCW(3, 3)) / std::pow(v1, 2) - HCW(4, 6) / (v1 * v2) +
                  HCW(5, 7) / (v1 * v2) + (2 * HCW(7, 7)) / std::pow(v1, 2));
  ...
  std::vector<double> CRelations{
      ...
      v2 * HCW(0, 3) - v1 * HCW(4, 5) + v2 * HCW(5, 6),

      v2 * HCW(0, 3) - v1 * HCW(4, 5) - v2 * HCW(4, 7),

      std::pow(v1, 2) * HCW(4, 5) + std::pow(v2, 2) * HCW(6, 7),
...
void Class_Potential_C2HDM_CTReL6::TripleHiggsCouplings()
{
  if (!SetCurvatureDone) SetCurvatureArrays();
...
void Class_Potential_C2HDM_CTReL6::SetCurvatureArrays()
{
  initVectors();
...
bool Class_Potential_C2HDM_CTReL6::CalculateDebyeSimplified()
{
  double cb = 0;
...
bool Class_Potential_C2HDM_CTReL6::CalculateDebyeGaugeSimplified()
{
...
double Class_Potential_C2HDM_CTReL6::VTreeSimplified(
...
double Class_Potential_C2HDM_CTReL6::VCounterSimplified(
    const std::vector<double> &v) const
{
  (void)v;
...
void Class_Potential_C2HDM_CTReL6::Debugging(const std::vector<double> &input,
