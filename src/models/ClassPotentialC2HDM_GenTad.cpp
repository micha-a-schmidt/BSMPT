...
#include <BSMPT/models/ClassPotentialC2HDM_GenTad.h>
...
namespace Models
{
Class_Potential_C2HDM_GenTad::Class_Potential_C2HDM_GenTad()
{
  // TODO Auto-generated constructor stub
  Model         = ModelID::ModelIDs::C2HDMGENTAD;
  NNeutralHiggs = 4;
  NChargedHiggs = 4;
 ...
 */
std::vector<std::string> Class_Potential_C2HDM_GenTad::addLegendCT() const
{
 ...
 * inputfile
 */
std::vector<std::string> Class_Potential_C2HDM_GenTad::addLegendTemp() const
{
  std::vector<std::string> labels;
...
Class_Potential_C2HDM_GenTad::addLegendTripleCouplings() const
{
  std::vector<std::string> labels;
 ...
 */
std::vector<std::string> Class_Potential_C2HDM_GenTad::addLegendVEV() const
{
  std::vector<std::string> labels;
...
void Class_Potential_C2HDM_GenTad::ReadAndSet(const std::string &linestr,
...
void Class_Potential_C2HDM_GenTad::set_gen(const std::vector<double> &p)
{
...
void Class_Potential_C2HDM_GenTad::set_CT_Pot_Par(const std::vector<double> &p)
{
  //	double *p = (double *)par;
 ...
 */
void Class_Potential_C2HDM_GenTad::write() const
{
 ...
 * conserving)
 */
std::vector<double> Class_Potential_C2HDM_GenTad::calc_CT() const
{
  ...
  // DL3CT
  parCT.push_back(-dummy + (2 * HCW(1, 3)) / (v1 * v2) - HCW(4, 6) / (v1 * v2) -
                  HCW(5, 7) / (v1 * v2));

  // DL4CT
  parCT.push_back(dummy - (2 * HCW(1, 3)) / (v1 * v2) +
                  (2 * HCW(5, 7)) / (v1 * v2));
  ...
  // DT1
  parCT.push_back(v1 * HCW(1, 1) + v2 * HCW(1, 3) - NCW(4));
...
void Class_Potential_C2HDM_GenTad::TripleHiggsCouplings()
{
  if (!SetCurvatureDone) SetCurvatureArrays();
...
void Class_Potential_C2HDM_GenTad::SetCurvatureArrays()
{
  initVectors();
...
bool Class_Potential_C2HDM_GenTad::CalculateDebyeSimplified()
{
  double cb = 0;
...
bool Class_Potential_C2HDM_GenTad::CalculateDebyeGaugeSimplified()
{
...
double Class_Potential_C2HDM_GenTad::VTreeSimplified(
...
double Class_Potential_C2HDM_GenTad::VCounterSimplified(
    const std::vector<double> &v) const
{
  (void)v;
...
void Class_Potential_C2HDM_GenTad::Debugging(const std::vector<double> &input,
