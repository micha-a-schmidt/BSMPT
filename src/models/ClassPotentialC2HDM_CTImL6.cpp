...
namespace Models
{
Class_Potential_C2HDM_CTImL6::Class_Potential_C2HDM_CTImL6()
{
  // TODO Auto-generated constructor stub
  Model         = ModelID::ModelIDs::C2HDMCTIML6;
  NNeutralHiggs = 4;
  NChargedHiggs = 4;
 ...
 */
std::vector<std::string> Class_Potential_C2HDM_CTImL6::addLegendCT() const
{
 ...
 * inputfile
 */
std::vector<std::string> Class_Potential_C2HDM_CTImL6::addLegendTemp() const
{
  std::vector<std::string> labels;
...
Class_Potential_C2HDM_CTImL6::addLegendTripleCouplings() const
{
  std::vector<std::string> labels;
 ...
 */
std::vector<std::string> Class_Potential_C2HDM_CTImL6::addLegendVEV() const
{
  std::vector<std::string> labels;
...
void Class_Potential_C2HDM_CTImL6::ReadAndSet(const std::string &linestr,
...
void Class_Potential_C2HDM_CTImL6::set_gen(const std::vector<double> &p)
{
...
void Class_Potential_C2HDM_CTImL6::set_CT_Pot_Par(const std::vector<double> &p)
{
  //	double *p = (double *)par;
 ...
 */
void Class_Potential_C2HDM_CTImL6::write() const
{
 ...
 * conserving)
 */
std::vector<double> Class_Potential_C2HDM_CTImL6::calc_CT() const
{
  ...
  };//CRelations must be numerical zero, since these correspond to the additional conditions for the CT-solutions
  /////////////////////////////////////////////////
...
void Class_Potential_C2HDM_CTImL6::TripleHiggsCouplings()
{
  if (!SetCurvatureDone) SetCurvatureArrays();
...
void Class_Potential_C2HDM_CTImL6::SetCurvatureArrays()
{
  initVectors();
...
bool Class_Potential_C2HDM_CTImL6::CalculateDebyeSimplified()
{
  double cb = 0;
...
bool Class_Potential_C2HDM_CTImL6::CalculateDebyeGaugeSimplified()
{
...
double Class_Potential_C2HDM_CTImL6::VTreeSimplified(
...
double Class_Potential_C2HDM_CTImL6::VCounterSimplified(
    const std::vector<double> &v) const
{
  (void)v;
...
void Class_Potential_C2HDM_CTImL6::Debugging(const std::vector<double> &input,
